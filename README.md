...
## 参考資料・謝辞
本ツールで使用している計算式や考え方の一部は
以下の投稿内容を参考にしています。

X(旧Twitter) あんこ(@bpsr_anK)様 投稿
- https://x.com/bpsr_anK/status/2010966019771408632
> ※66→54 64→51の修正は適用済み
...
本ツールの「鍛造における期待値計算」や  
「単品利益と長期的な平均利益の考え方」は、  
以下の投稿で行われている検証・考察を参考にしています。

**X(旧Twitter) あんこ様(@bpsr_anK)**
- 鍛造1回あたりの生成個数を統計的に整理した検証投稿  
  https://x.com/bpsr_anK/status/2010966019771408632
